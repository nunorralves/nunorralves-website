...
language: en
author: Nuno Alves
excerpt: Last week was an exciting one for Next.js developers. Version 10 was released and presented on Next.js Conference. Let's check the top 5 new features released!
date: 2020-11-02
coverImage: '/images/top-5-nextjs-10-new-features/cover.png'
tags: ['nextjs', 'nextjs 10']
---
import PhotoCredits from '../../components/PhotoCredits';

![Top 5 Next.js 10 new features](/images/top-5-nextjs-10-new-features/cover.png)
<PhotoCredits
  credits={{
    author: 'Vercel',
    authorUrl: 'https://vercel.com/',
    site: 'Next.js',
    siteUrl: 'https://nextjs.org/conf/schedule'
  }}
/>
...
![Top 5 Next.js 10 new features](/images/top-5-nextjs-10-new-features/nextjs-analytics.png)
<PhotoCredits
  credits={{
    author: 'Vercel',
    authorUrl: 'https://vercel.com/',
    site: 'Next.js',
    siteUrl: 'https://nextjs.org/analytics'
  }}
/>
...
![Top 5 Next.js 10 new features](/images/top-5-nextjs-10-new-features/nextjs-commerce.png)
<PhotoCredits
  credits={{
    author: 'Vercel',
    authorUrl: 'https://vercel.com/',
    site: 'Next.js',
    siteUrl: 'https://nextjs.org/commerce'
  }}
/>
